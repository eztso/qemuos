...
void Ide::readSector(uint32_t sector, void* buffer) {
...
int32_t Ide::read(uint32_t offset, void* buffer, uint32_t n) {
...
int32_t Ide::readAll(uint32_t offset, void* buffer_, uint32_t n) {
...
int32_t Ide::writeAll(uint32_t offset, const void* buffer_, uint32_t n) {
